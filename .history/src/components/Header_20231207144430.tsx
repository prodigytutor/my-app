...
const header: React.FC<IAppProps> = () => { 
    return (
        <header>
        <p className="mb-2 text-sm font-semibold text-blue-600">Domainz</p>
        <h1 className="block text-2xl font-bold text-gray-800 sm:text-3xl dark:text-white">Web Asset Management and more...</h1>
        <p className="mt-2 text-lg text-gray-800 dark:text-gray-400">One centralized place to manage all your web assets.</p>
